...
# +
df_14 = gpd.read_file('14.소유지정보_10.geojson')
# 급속 충전소 설치 가능 장소
...
layer = pdk.Layer( 'PolygonLayer', # 사용할 Layer 타입 
                  ...
                  get_polygon='coordinates', # geometry 정보를 담고있는 컬럼 이름 
                  get_fill_color='[0, 255*1, 0]', # 각 데이터 별 rgb 또는 rgba 값 (0~255) 
                  pickable=True, # 지도와 interactive 한 동작 on 
                  auto_highlight=True # 마우스 오버(hover) 시 박스 출력 
                 ) 
...
# Render 
r = pdk.Deck(layers=[layer5,scatt,opt], initial_view_state=view_state)
#             mapbox_key = "pk.eyJ1IjoiamNsYXJhODExIiwiYSI6ImNrZzF4bWNhdTBpNnEydG54dGpxNDEwajAifQ.XWxOKQ-2HqFBVBYa-XoS-g"
