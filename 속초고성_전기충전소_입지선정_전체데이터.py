...
# df_20 = gpd.read_file("19.법정경계(읍면동).geojson")
...
# ### 분석 결과
# - 퇴근 시간을 피한 오후 14시에 교통량이 많은 곳은 관광객이 많이 가는 지역일 것으로 기대
...
#
# **분석 설명**
# - 각 100X100 Point 마다 11시 교통량, 14시 교통량, 혼잡빈도강도합, 혼잡시간강도합, 자동차등록, 전기자동차등록을 부여
